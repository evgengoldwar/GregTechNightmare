...
public class PipeActivityMessage implements IMessage {
    ...
    public static class ClientHandler implements IMessageHandler<PipeActivityMessage.PipeActivityData, IMessage> {

        @Override
        public IMessage onMessage(PipeActivityMessage.PipeActivityData message, MessageContext ctx) {
    ...
    public static class ServerHandler implements IMessageHandler<PipeActivityMessage.PipeActivityQuery, IMessage> {

        @Override
        public IMessage onMessage(PipeActivityMessage.PipeActivityQuery message, MessageContext ctx) {
            ...
            if (world != null) {
                ...
                if (te instanceof IGregTechTileEntity gregTile) {
                    ...
                    if (meta instanceof IActivePipe activePipe) {
                        ...
                        return new PipeActivityMessage.PipeActivityData(message);
                    }
                }
            }
            return null;
